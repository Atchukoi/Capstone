...
if (isset($_POST['submit'])) {
	...
	if ($UserId != "") {
		...
		header('Location: http://localhost/hms/capstone/bookballroomhall.php?Id='.$UserId.'&d='.$date.'');
				...
				<div class="row">
					<div class="row">
						<div class="col" style="margin-top: 5px; margin-left: 5px ">
							<span class="glyphicon glyphicon-info-sign"></span> This reservation form if for a  <b><i> Ballroom Hall </i></b> with a <b><i>Rate of ₱ 10,000 per 4 Hours</i></b> and  <b><i> exceeding rate per hour is ₱ 1000</i></b>
						</div>
					</div>
					<div class="row">
						<div class="col" style="margin-top: 5px; margin-left: 5px ">
							<span class="glyphicon glyphicon-info-sign"></span> <b><i> 1 dot in a selected date </i></b> means the room category is fully booked.
						</div>
					</div>
					<div class="row">
						<div class="col" style="margin-top: 5px; margin-left: 5px ">
