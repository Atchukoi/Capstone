...
if (isset($_POST['submit'])) {
    ...
    if ($result) {
        header("Location: bookinglist.php?msg= Reservation has been Updated Succesfully");
    } else {
...
<body style="background-color: rgba(237, 195, 238, 0.8);">
  ...
  border-image: linear-gradient(to right, darkblue, darkorchid) 1">
        ...
        <div class="row justify-content-end mb-5">
            ...
            <div class="col-lg-2 mt-4">
                <a type="button" class="btn btn-danger" style="margin:auto; width:100%;" href="index.php">Cancel</a>
            </div>
