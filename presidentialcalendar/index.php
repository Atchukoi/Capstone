...
if (isset($_POST['submit'])) {
	...
	if ($UserId != "") {
        ...
        VALUES 
        ('$Code','1','$Arrival','$Departure','$Total','$UserId','Pending','$Remarks')";
...
<div class="container">
	<h2>Presidential Villa Calendar </h2>
				...
				<div class="row">
					<div class="row">
						<div class="col" style="margin-top: 5px; margin-left: 5px ">
							<span class="glyphicon glyphicon-info-sign"></span> This reservation form if for a room with a type category <b><i> PRESIDENTIAL VILLA</i></b> with a <b><i>Rate of ₱ 3,500 per day</i></b>
						</div>
					</div>
					<div class="row">
						<div class="col" style="margin-top: 5px; margin-left: 5px ">
