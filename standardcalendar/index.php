...
if (isset($_POST['submit'])) {
	...
	if ($UserId != "") {
        ...
        VALUES 
        ('$Code','4','$Arrival','$Departure','$Total','$UserId','Pending','$Remarks')";
				...
				<div class="row">
					<div class="row">
						<div class="col" style="margin-top: 5px; margin-left: 5px ">
							<span class="glyphicon glyphicon-info-sign"></span> This reservation form if for a room with a type category <b><i> Standard </i></b> with a <b><i>Rate of ₱ 2,500 per day</i></b>
						</div>
					</div>
					<div class="row">
						<div class="col" style="margin-top: 5px; margin-left: 5px ">
