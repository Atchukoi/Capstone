...
<div class="card mb-4">
  ...
  <li class="nav-item">
    <a class="nav-link active bg-primary text-white" aria-current="page" href="fhrraccepted.php">Accepted</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="fhrrpending.php">Pending</a>
  </li>
  ...
  <li class="nav-item">
    ...
    <table id="datatablesSimple" >
      ...
      <tbody>
        ...
        WHERE rr.Status = 'Accepted' AND rc.RoomTypeId=2";
        ...
        ?>
          <tr class="text-center">
            ...
            <td class="text-center ">
                ...
                <a href="function/hall/book.php?Id=<?php echo $row['Id'] ?>" class="btn btn-primary mb-1"><i class="fa-solid fa-right-from-bracket"></i></i> Book</a>
