                        ...
                        <tbody>
                            ...
                            ?>
                                <tr class="text-center">
                                    <td ><strong><?php echo $row['Type'] ?></td>
                                    <td><?php echo $row['Description'] ?></td>
                                    <td ><i class="fa-solid fa-person"></i> <?php echo $row['Person'] ?></td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="function/hrmanage/rtdelete.php?id=<?php echo $row['Id'] ?>& name=<?php echo $row['Type'] ?>" class="btn btn-danger mb-1"><i class="far fa-trash-alt"></i> Delete</a>
                                    </td>
                                </tr>
                            <?php
                            }
            ...
            <div class="col-sm-4 my-3" style="border-left: solid black 5px;">
                <form method="POST">
                    ...
                    if(isset($_POST['submit'])) {
                        ...
                        $sql = "INSERT INTO `tblroomtype`(`Type`, `Description`, `Person`, `Rate`) VALUES ('$Type','$Description','$Person','$Rate')";
                        $result = mysqli_query($conn,$sql);
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="number" name="Rate" class="form-control" placeholder="e.g. 3000" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
