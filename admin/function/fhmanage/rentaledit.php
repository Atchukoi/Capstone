...
if (isset($_POST['submit'])) {
    ...
    if ($result) {
        header("Location: ../../rentals.php?msg=$Name has been Updated succesfully!");
    } else {
  ...
  border-image: linear-gradient(to right, darkblue, darkorchid) 1">
        ...
        <form method="POST">
            ...
            <div class="row mb-3">
                ...
                <div class="col-lg-6 mt-4">
                    <a type="button" class="btn btn-danger" style="margin:auto; width:100%;" href="../../rentals.php">Cancel</a>
                </div>
            </div>
        </form>
    </div>
