...
if (isset($_POST['displaySend'])) {
    ...
    FROM roomextra re
    WHERE re.RoomTypeID = 2 And re.ExtraCategoryId= 5";
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        <div class="input-group">
            <input type="number" min="0" name="R[]" data-rental="rental-' . $Id . '" id="' . $Id . '" class="form-control corckage-input" onchange="corckage('.$Id.')" onkeyup="corckage('.$Id.')">
