...
WHERE rr.Id = $id";
  ...
  border-image: linear-gradient(to right, darkblue, darkorchid) 1">
        ...
        <div class="row text-center my-5">
            <h1>Please assign a room for the reservation</h1>
        </div>
                ...
                <form action="" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="input-group">
                                <div class="input-group-text">₱</div>
                                <input type="number" name="Deposit" class="form-control" min="0" value="<?php echo $row['Deposit'] ?>">
                            </div>
                        </div>
                        <div class="col-lg-3">
                            ...
                            <div class="input-group">
                                <select class="form-select" name="PaymentType" aria-label="Default select example">
                                    <option selected value="<?php echo $row['PaymentType'] ?>"><?php echo $row['PaymentType'] ?></option>
