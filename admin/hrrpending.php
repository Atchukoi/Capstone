...
<ul class="nav nav-tabs">
  ...
  <li class="nav-item">
    <a class="nav-link active bg-primary text-white"  aria-current="page" href="hrrpending.php">Pending</a>
  </li>
  <li class="nav-item">
  ...
  <table id="datatablesSimple" class="table table-striped ">
    ...
    <tbody>
      <?php
      $sql = "SELECT rr.Id, rr.Code, roomrate.RoomCategoryId, rr.Arrival, rr.Departure,u.Id AS GuestId, CONCAT(u.FirstName,' ', u.LastName) AS Name, u.Contact, rr.Status, rc.Title, rr.PaymentType, rr.PaymentLink
      ...
      WHERE rr.Status = 'Pending' AND rc.RoomTypeId=1;";
      ...
      ?>
        <tr class="text-center">
          ...
          <td><?php echo $row['PaymentLink'] ?></td>
